const mocks = [
  ...
  {
    imageUrl: "https://i.pravatar.cc/150?u=3@pravatar.com",
    tagline: "French speaking for english speaking",
    message: `
   I have been learning french for sometime now and would love to speak with a native speaker in exchange I am also happy to speak with you in english, its my mother tongue`,
    interests: `Sorry cant be flexible with other offers`,
    offer: "Teach",
  },
  {
    imageUrl: "https://i.pravatar.cc/150?u=4@pravatar.com",
    tagline: "Backend developement for Frontend development",
    message: `
    ...
    interests: `Happy to also exchange for devops lesson :)`,
    offer: "Learn",
  },
];
